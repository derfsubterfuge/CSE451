...
/*
	MAX_NUM_StATUSES represents the maximum number of statuses
	that we are keeping track of for each API
*/
#define MAX_NUM_STATUSES 8

/*
	STATUS_COUNT is simply a tuple used to keep track between which status
	has been returned by some funciton, N number of times
*/
typedef struct _STATUS_COUNT {
	NTSTATUS Status;
	ULONG Count;
...
/*
	...
	and NtWriteFile) represents the number of bytes transfered by 
	some particular API.  StatusCounts represents the number of NumStatuses represents the number of 
...
/*
	...
	Each index of ApiStatus corresponds to an API in CSE451_APIS.
*/
