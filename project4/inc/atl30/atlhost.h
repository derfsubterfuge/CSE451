...
#pragma warning(default: 4310) // cast truncates constant value
		...
		return (m_bstrOptionKeyPath == bstrOptionKeyPath) ? S_OK : E_OUTOFMEMORY;
        }
		...
		return (*pbstrOptionKeyPath == m_bstrOptionKeyPath) ? S_OK : E_OUTOFMEMORY;
        }
