...
public:
		...
		if (szFileName == NULL)
			return E_OUTOFMEMORY;
                ...
                hr = szFullFileName.Append(szFileName); 
                if (FAILED(hr))
                {
                    return hr;
                }
...
public:
        ...
        STDMETHOD(SetInterfaceSafetyOptions)(REFIID riid, DWORD dwOptionSetMask, DWORD dwEnabledOptions)
        {
                ...
                m_dwCurrentSafety = (m_dwCurrentSafety & ~dwOptionSetMask) | (dwEnabledOptions & dwOptionSetMask);
                return S_OK;
        }
...
#ifdef ATL_CTL_STRICT_HWND
        HRESULT STDMETHODCALLTYPE put_Window(HWND /*hWnd*/)
#else
