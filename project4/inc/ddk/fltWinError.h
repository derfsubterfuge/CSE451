...
//      +-+-+-+-+-+---------------------+-------------------------------+
//      |S|R|C|N|r| FltMgr Facility     |(Code part of FltNtStatus)     |
...
//
//         Code - Code portion of the NTSTATUS with bit 15 set (therefore
//                this code portion will always have the high bit set)
//
//      **NOTE:  This funniness with setting bit 15 in the conversion from
//               Filter Manager NTSTATUS to HRESULT is done to allow automated
//               translation of NTSTATUS error codes to HRESULTs for both
//               Win32 error codes and Filter Manager NTSTATUS codes.  By
//               setting bit 15, we can ensure that the Filter Manager Library
//               HRESULTs generated from Win32 codes will not overlap the
//               Filter Manager Library HRESULTs generated from Filter Manager
//               NTSTATUS codes.
//
//  Arguments:
//
