...
#if defined(UNICODE)
	LONG QueryDWORDValue(__in_z_opt LPCTSTR pszValueName, DWORD& dwValue);
...
#endif
	LONG QueryStringValue(__in_z_opt LPCTSTR pszValueName, __out_ecount_part(*pnChars, *pnChars) __out_z LPTSTR pszValue, __inout ULONG* pnChars);
#endif
