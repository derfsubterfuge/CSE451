...
#define KernelThreadObjectLength 0x378
#define ExecutiveThreadObjectLength 0x498
...
#define PcOsMcaResource 0xc70
#define PcOsInitResource 0xd58
#define PcOsMcaRecInfo 0x4780
#define PcPrcbData 0xe80
#define MAX_NUMBER_OF_IHISTORY_RECORDS 0x80
#define ProcessorControlRegisterLength 0x4980
#define UsTickCountMultiplier 0x4
#define UsInterruptTime 0x8
#define UsSystemTime 0x14
...
#define PbExceptionDispatchCount 0x11a0
#define PbSystemCalls 0x11a4
#define PbStartCycles 0x1280
#define PbCycleTime 0x1288
#define PbLockQueue 0x12f0
#define PbPacketBarrier 0x1600
#define PbCurrentPacket 0x1680
#define PbTargetSet 0x1698
#define PbWorkerRoutine 0x16a0
#define PbBranchHistory 0x16b0
#define PbRequestSummary 0x1700
#define PbSignalDone 0x1708
#define PbDpcListHead 0x1780
#define PbDpcLock 0x1790
#define PbDpcQueueDepth 0x1798
#define PbDpcCount 0x179c
#define PbDpcStack 0x17c0
#define PbMaximumDpcQueueDepth 0x17c8
#define PbDpcRequestRate 0x17cc
#define PbMinimumDpcRate 0x17d0
#define PbDpcLastCount 0x17d8
#define PbDpcInterruptRequested 0x17d4
#define PbDpcThreadRequested 0x17d5
#define PbDpcRoutineActive 0x17d6
#define PbDpcThreadActive 0x17d7
#define PbTimerHand 0x17e0
#define PbQuantumEnd 0x17e9
#define PbDpcSetEventRequest 0x17ec
#define PbAdjustDpcThreshold 0x17f0
#define PbStartCount 0x17f8
#define PbIdleSchedule 0x17ea
#define PbDeferredReadyListHead 0x18a0
#define PbPrcbLock 0x1898
#define PbReadySummary 0x18a8
#define PbDispatcherReadyListHead 0x1900
#define PbSkipTick 0x1b00
#define PbPowerState 0x1b08
#define ProcessorBlockLength 0x3900
